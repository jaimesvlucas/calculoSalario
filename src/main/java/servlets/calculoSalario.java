...
public class calculoSalario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            float salarioNeto = salarioBruto - (salarioBruto*tipoIva/100);
            ...
            out.println("<h2>Nombre del empleado/a "+nombreEmpleado+"</h2>");
            out.println("<h2>Tipo de retención "+tipoIva+"</h2>");
